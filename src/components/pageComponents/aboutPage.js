...
import ada from "../../assets/img/ada.jpeg"
      ...
      <Layout location={this.props.location}>
          ...
          <div className="container">
            <div className="row intro">
              <div className="col-12 intro__text">
                <h3 className="l1-txt2 p-b-40">
                  About Us <i className="dot-box dot-box_yellow"></i>
                </h3>
                <h4>
                  AT Cre8tive Tech <i className="underline-box"></i>
                </h4>
                <p>
                  We are focused on the provision of digital and IT solutions,
                  aimed at driving the effective operation and growth hack of
                  various brands. We invest in our collaborative workspace
                  community, to ensure a continuous stream of inspiration. By
                  investing in an environment that breeds creativity, we inspire
                  ourselves to develop flexible solutions that ensure a seamless
                  workflow, for brands. At Cre8tive Tech, we are not just
                  dreamers, we deliver!
                </p>
                <div onClick={this.openVideoModal} className="play">
                  <i class="zmdi zmdi-play"></i>
                </div>{" "}
                <p className="play-text">Take a Tour</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="team" className="boxb">
          <div className="container boxb__content">
            <h3 className="l1-txt1 txt-center p-b-80">
              Team <i className="dot-box dot-box_yellow"></i>
            </h3>
            ...
            <div className="row team">
              ...
              <div class="col-3 team-feed">
                <div className="team-image">
                  <img className="lazyload" data-src={john} alt="" />
                </div>
                <div className="team-details">
                  <h3>Okoro John A.</h3>
              ...
              <div class="col-3 team-feed">
                <div className="team-image">
                  <img className="lazyload" data-src={ada} alt="" />
                </div>
                <div className="team-details">
                  <h3>Nwakwuo Stephanie A.</h3>
          ...
          <div className="container">
            <div className="row">
              <div className="mission-item">
                <h4>
                  OUR VISSION <i className="underline-box"></i>
                </h4>
                <p className="p-b-20">
                  We envision leading Top African Brands by the hand, to take on
                  new horizons and opportunities, in a creative digital
                  ecosystem where brand-consumer connection thrives.
                </p>
              </div>
              <div className="mission-item">
                <h4>
                  OUR MISSION <i className="underline-box"></i>
                </h4>
                <p>
                  To breed and employ the creativity of Top Talents in the
                  delivery of quality and innovative solutions, which would
                  ensure that effectiveness, efficiency, and growth are
                  expressly experienced by partner brands.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="boxe">
          <div className="container">
            <h3 className="l1-txt1 txt-center p-b-80">
              ...
              <i className="dot-box dot-box_yellow"></i>
            </h3>
