    ...
    return (
        ...
        <section className="boxa">
          <div className="container">
            <div className="row intro">
              ...
              <h3 className="l1-txt2 p-b-80">About Us <i className="dot-box"></i></h3>           
        ...
        <section id="services" className="boxb">
          <div className="container boxb__content">
              ...
              <h3 className="l1-txt1 txt-center p-b-80">Team <i className="dot-box"></i></h3>
        ...
        <section className="boxe">
          <div className="container">
            ...
            <h3 className="l1-txt1 txt-center p-b-80">Brands We've Worked With <i className="dot-box"></i></h3>
            ...
            <div className="row">
              ...
              <div className="clients__box">
               <img src={ablegenius} alt=""/>
              </div>
              <div className="clients__box">
               <img src={restable} alt=""/>
              </div>
              <div className="clients__box">
               <img src={topline} alt=""/>
              </div>
